  ...
  return (
                <div>
                    <div className="flex flex-col gap-1 mt-4">
                        <Button  onClick={() => currentUser?.stripePurchasedId ? router.push(`/course/${courseId}/access`): router.push(`/learnable-plus` )}  className="py-6 text-center hover:bg-black hover:text-white rounded-none bg-purple-600 text-white" >{currentUser?.stripePurchasedId ? 'Go to course':'Get course now'}</Button>
