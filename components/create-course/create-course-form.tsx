  ...
  <div className='flex items-center space-x-4 w-full py-4 text-white uppercase text-md font-bold justify-center'>
      {links.map((item) => (
        <span key={item.name} className={`flex w-[200px] items-center gap-2 cursor-pointer`}>
           ...
           <Circle color="#fff" strokeWidth={2} className={`rounded-full ${steps === item.step ? 'bg-purple-600' : ''}`}/>
        </span>
      ))}
  </div>
            ...
            <div className='h-[70vh] justify-center flex items-center'>
                <div className='flex items-center flex-col gap-4'>
                  <div className='space-y-4'>
                    ...
                    <Input value={state.title} placeholder='Javascript course e.g' id='name' name='title' type='text' onChange={handleChange} className='h-12 w-[800px] text-black dark:text-white'/> 
                  </div>
            ...
            <div className='h-[70vh] justify-center flex items-center'>
                <div className='flex items-center flex-col gap-4'>
                  <div className='space-y-4'>
                    ...
                    <Input value={state.description} placeholder='Learn typescript from scratch 2023' id='description' name='description' type='text' onChange={handleChange} className='h-12 p-10 w-[800px] text-black dark:text-white'/> 
                  </div>
    ...
    {steps === STEPS.CONTENT && (
      ...
      <div>
            ...
            <Button variant="secondary" className='py-2' onClick={handleButtonClick}>Add Video</Button>
              ...
              <Button disabled={isLoading} onClick={onSubmit} type='button'>Upload</Button>
              )}
              <Button onClick={onBack} type='button'>Back</Button>
